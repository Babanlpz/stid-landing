import { version, getCurrentInstance, inject, ref, watchEffect, watch, useSSRContext, createApp, reactive, unref, mergeProps, provide, onErrorCaptured, onServerPrefetch, toRef, h, isReadonly, defineAsyncComponent, isRef } from 'file:///Users/ludo9p/www/stid-landing/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/ludo9p/www/stid-landing/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/ludo9p/www/stid-landing/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///Users/ludo9p/www/stid-landing/node_modules/unctx/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/ludo9p/www/stid-landing/node_modules/@unhead/ssr/dist/index.mjs';
import { getActiveHead, createServerHead as createServerHead$1 } from 'file:///Users/ludo9p/www/stid-landing/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/ludo9p/www/stid-landing/node_modules/@unhead/shared/dist/index.mjs';
import { hasProtocol, parseURL, joinURL, isEqual, stringifyParsedURL, stringifyQuery, parseQuery, withLeadingSlash, encodePath } from 'file:///Users/ludo9p/www/stid-landing/node_modules/ufo/dist/index.mjs';
import { sendRedirect, createError as createError$1, setResponseStatus as setResponseStatus$1 } from 'file:///Users/ludo9p/www/stid-landing/node_modules/h3/dist/index.mjs';
import { defu } from 'file:///Users/ludo9p/www/stid-landing/node_modules/defu/dist/defu.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderSuspense, ssrRenderComponent } from 'file:///Users/ludo9p/www/stid-landing/node_modules/vue/server-renderer/index.mjs';
import { a as useRuntimeConfig$1 } from '../nitro/nitro-prerenderer.mjs';
import 'file:///Users/ludo9p/www/stid-landing/node_modules/node-fetch-native/dist/polyfill.mjs';
import 'file:///Users/ludo9p/www/stid-landing/node_modules/destr/dist/index.mjs';
import 'file:///Users/ludo9p/www/stid-landing/node_modules/unenv/runtime/fetch/index.mjs';
import 'file:///Users/ludo9p/www/stid-landing/node_modules/scule/dist/index.mjs';
import 'file:///Users/ludo9p/www/stid-landing/node_modules/ohash/dist/index.mjs';
import 'file:///Users/ludo9p/www/stid-landing/node_modules/unstorage/dist/index.mjs';
import 'file:///Users/ludo9p/www/stid-landing/node_modules/unstorage/drivers/fs.mjs';
import 'file:///Users/ludo9p/www/stid-landing/node_modules/radix3/dist/index.mjs';
...
const appHead = { "meta": [{ "charset": "utf-8" }, { "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "hid": "description", "name": "description", "content": "Discover what our open technologies can offer" }], "link": [{ "rel": "icon", "type": "image/x-icon", "href": "/favicon.ico" }], "style": [], "script": [{ "hid": "gtmHead", "innerHTML": "\n            (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':\n            new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],\n            j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=\n            'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);\n            })(window,document,'script','dataLayer','GTM-T4FX7CL');" }], "noscript": [], "title": "Stid", "htmlAttrs": { "lang": "en-us" } };
...
async function _imageMeta(url) {
  {
    const imageMeta2 = await import('file:///Users/ludo9p/www/stid-landing/node_modules/image-meta/dist/index.mjs').then((r) => r.imageMeta);
...
const cloudinaryRuntime$hfwtWnUJgY = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage
});
const imageOptions = {
...
imageOptions.providers = {
  ["cloudinary"]: { provider: cloudinaryRuntime$hfwtWnUJgY, defaults: { "baseURL": "https://res.cloudinary.com/df7vlavbp/", "modifiers": { "format": "auto", "quality": "auto:good" } } }
};
const plugin_J4HI26ZYQS = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-e908c8c7.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-8800f539.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
